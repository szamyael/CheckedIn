/// Student-facing terms describing data collection and use in CheckedIn.
class StudentTermsContent {
  StudentTermsContent._();

  static const title = 'Terms & Privacy Notice';
  static const lastUpdated = 'August 2026';

  static const intro =
      'By using CheckedIn, you agree to how your institution collects and uses '
      'your information for attendance and event participation. Please read this '
  ...
  static const sections = [
    StudentTermsSection(
      ...
      paragraphs: [
        'CheckedIn is used by your school or organization to manage event attendance. '
            'Your institution is responsible for student accounts and attendance records. '
            'CheckedIn provides the software that stores and processes this data on their behalf.',
      ],
    ),
    StudentTermsSection(
    ...
    StudentTermsSection(
      ...
      paragraphs: [
        'Your data is accessible to you through the student app and portal. Authorized '
            'organization administrators, faculty, and system administrators at your '
            'institution can view attendance and profile information needed to run events '
            'and generate reports. CheckedIn does not sell your personal information.',
      ],
    ),
    StudentTermsSection(
    ...
    StudentTermsSection(
      ...
      paragraphs: [
        'Your information is kept for as long as your student account is active and as '
            'required by your institution\'s policies. Attendance and verification records '
            'may be retained for academic and audit purposes. Data is transmitted over '
            'encrypted connections and access is restricted by role-based permissions.',
      ],
    ),
    StudentTermsSection(
    ...
    StudentTermsSection(
      title: '8. Acceptance',
      paragraphs: [
        'By tapping "I accept" below, you confirm that you have read and agree to this '
            'notice and consent to the collection and use of your information as described '
            'for attendance and related services at your institution.',
      ],
    ),
  ];
}

class StudentTermsSection {
  final String title;
  final List<String> paragraphs;
  final List<String> bullets;

  const StudentTermsSection({
    required this.title,
